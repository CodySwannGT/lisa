...
Create an agent team to create an implementation plan for: $ARGUMENTS
...
The plan must include explicit instructions to "Create an agent team" for implementation. Recommend these specialized agents:
