...
8. Check for legacy inline Codex workflows that need migration. For each file in `.github/workflows/` matching `Codex*.yml`, `Codex*.yaml`, `ci.yml`, `ci.yaml`, `deploy.yml`, and `deploy.yaml`:
