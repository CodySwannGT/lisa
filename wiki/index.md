...
- [TASC — Trust in Autonomous Software Criteria](concepts/tasc-specification.md)
  - SOC 2-parity attestation spec for autonomous development; AC1–AC9 mirror CC1–CC9; Type C continuous attestation; 0.2.0 adds evidence authenticity, finding and measurement integrity, generative testing, and distributional model qualification; draft source at [spec/tasc-0.1-draft.md](../spec/tasc-0.1-draft.md).
