...
- project_lisa_update_workspaces_config.md (memory entry: project_lisa_update_workspaces_config.md) — lisa-update-projects reads its project list from .lisa.workspaces.json (not the .lisa.config.local.json the doc names); acmeorga repos live under acmeorga/projects/
