...
- Historical Agy parity work established that Agy reads only user-global MCP and plugin hooks. The 2026-07-10 project-scope decision retired those automatic writes/installs; Lisa now emits project files and documents the resulting Agy capability gaps.
