...
describe('CopyOverwriteStrategy', () => {
  ...
  it('copies new file when destination does not exist', async () => {
    ...
    const result = await strategy.apply(srcFile, destFile, 'test.txt', createContext());
  ...
  it('creates parent directories when needed', async () => {
    ...
    await strategy.apply(srcFile, destFile, 'nested/deep/test.txt', createContext());
  ...
  it('does not modify files in dry run mode', async () => {
    ...
    const result = await strategy.apply(srcFile, destFile, 'test.txt', createContext({ dryRun: true }));
