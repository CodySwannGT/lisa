...
description: "Bootstrap a machine before any repository exists. Detects Lisa-supported agent CLIs plus universal factory tooling, reports what is present, and installs only missing tools when run with --yes. Vendor installers are visibly distinct from pinned, checksummed archive installs."
