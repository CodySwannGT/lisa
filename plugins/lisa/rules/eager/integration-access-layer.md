...
For missing AWS credentials, ask that broker for `LISA_AWS_BOOTSTRAP_JSON`
before proposing an interactive login. Its AWS recovery guidance reuses the
existing setup and account verification path.
