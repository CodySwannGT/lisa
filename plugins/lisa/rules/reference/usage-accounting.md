...
The optional effectiveness extension, clock definitions, and recurrence storage contract live in the [portable usage-accounting reference](../../skills/lisa-usage-accounting/references/effectiveness.md), shared by every supported agent. The primary 17-field usage token remains unchanged.
