...
For agent-composed JIRA or Confluence comments, apply `report-actionability` — **Agent attribution** before posting. Preserve an existing disclosure and the exact format of machine-managed comments.
