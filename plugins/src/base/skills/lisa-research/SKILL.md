...
new UI/visual work, a design-file pointer), overall acceptance criteria, open questions and
decisions (each carrying the drafter's recommended resolution and a one-sentence rationale), and
the "Recommended Tooling for Plan Phase" section. The final
