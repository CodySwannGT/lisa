...
- **Assert the wrong spelling is absent, not the right one present.** A test that the correct marker is *present* passes trivially when the file states it twice; the falsifiable form asserts the wrong form is gone.
