 ...
 *
 * Publishable factory function for NestJS ESLint configuration. Extends
 * TypeScript config with adjustments for NestJS patterns like decorators,
 * dependency injection, and class-based architecture.
 *
 * Inheritance chain:
 *   nestjs.ts (this file)
 *   -> typescript.ts
