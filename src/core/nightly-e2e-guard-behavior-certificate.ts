...
export const NIGHTLY_E2E_GUARD_BEHAVIOR_CERTIFICATES = Object.freeze({
  ...
  f4db87783eddb4fc8f326a1b033ef237b2a6070e1578cadbbe32b421248cff5e:
    Object.freeze({
      contractVersion: "1.9.0",
      packageVersions: Object.freeze(["4.55.2"]),
      provenances: Object.freeze([
        "workspace package @codyswann/lisa@4.55.2 (typescript/copy-overwrite/scripts/check-nightly-e2e-health.mjs)",
      ]),
    }),
});
