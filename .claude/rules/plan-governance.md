...
- Product/UX review using `product-specialist` agent
- CodeRabbit code review
- Local code review via `/plan-local-code-review`
- Technical review using `quality-specialist` agent
...
| `debug-specialist` | Root cause analysis, log investigation, definitive proof of bug causation |
...
| `test-specialist` | Writing comprehensive, meaningful tests |
| `verification-specialist` | Empirical proof that work is done (runs the system, creates verification scripts) |
